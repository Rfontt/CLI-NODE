...
describe('#Codegen 3-layes arch', () => {
    ...
    test('#should generate repository template', () => {
        ...
        const result = repositoryTemplate(repositoryName);
    ...
    test('#should generate service template', () => {
        ...
        const result = serviceTemplate(serviceName, repositoryName);
    ...
    test('#should generate factory template', () => {
        ...
        const result = factoryTemplate(factoryName, repositoryName, serviceName);
